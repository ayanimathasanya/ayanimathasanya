...
|---|---|---|
| **Home Stock** | Smart home inventory & grocery tracker with expiry alerts and real-time stock updates | MERN Stack, MongoDB |
| **Tasty Tales** | Recipe sharing platform connecting home cooks & food enthusiasts | React, Spring Boot, Java, MongoDB |
| **Surfing School MS** | Full school management system with scheduling, registration & payments | MERN Stack |
| **Health Insurance MS** | Policy registration, claim processing & premium payment platform | HTML, CSS, JS, MySQL |
| **Day Today Task App** | Mobile task tracker with daily reminders | Kotlin, Android Studio |
| **Online Coffee Shop** | Coffee ordering app with secure payment gateway integration | Mobile App |
